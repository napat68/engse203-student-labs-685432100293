...
| 12:xx | B2 | เพิ่มข้อความเมื่อค้นหาไม่พบ และตรวจว่า summary ยังใช้ข้อมูลทั้งหมด | แก้ RequestList ให้แสดงข้อความเมื่อ requests ว่าง และคง summary จาก requests เดิม | ทดสอบค้น `zzz` แล้วไม่พบรายการ พร้อมตรวจ summary ยังเป็น 5/3/1/1 |